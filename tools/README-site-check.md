...
| `google-tag` | A page configures `G-TYLYLJSFHN` without `AW-18182683015` (or the other way round), misses `gtag('set', 'ads_data_redaction', true)` or `gtag('set', 'url_passthrough', true)`, or configures the Ads id before GA4. The head block in `docs/PAGE_CONTRACT.md` §1 is verbatim. |
